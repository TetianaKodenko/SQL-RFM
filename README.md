...
* provide actionable insights (to prevent customer churn and maximize revenue from top-tier buyers).   
## **Tools & Technologies**    
**Snowflake Data Warehouse:** 
* TPCH_SF1 sample database

**SQL:**
* Common Table Expressions (CTEs),
* Aggregate Functions (MAX, SUM, AVG, COUNT, MEDIAN, QUARTILES),
